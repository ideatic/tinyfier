...
class HTML {
    ...
    /**
     * Elimina caracteres innecesarios de un documento HTML
     * @param string $html
     * @param boolean $compressAll Valor que indica si se comprimirá también el código CSS y JS hallado
     * @return string
     */
    public static function Process($html, $compressAll = false) {
        if ($compressAll) {
